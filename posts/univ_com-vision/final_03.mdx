...
HC는 rotation invariant 합니다.
즉, 영상을 회전시켜도 동일한 특징점을 찾아낼 수 있습니다.

하지만, transition invariant 하지는 않습니다.
즉, 영상을 이동시키면 동일한 특징점을 찾아낼 수 없습니다. (그레디언트가 같은데도 말이죠..)

또한, scale invariant 하지도 않습니다.
